...
export const products: Product[] = [
  ...
  {
    id: "10", name: "Mini caméra espion HD", slug: "mini-camera-espion",
  ...
  {
    id: "16", name: "Aspirateur robot ultra-plat", slug: "aspirateur-robot",
    category: "maison", price: 89.99, comparePrice: 139.99,
    description: "Robot aspirateur 2800Pa ultra-plat 7cm. Navigation intelligente, compatible Alexa.",
    features: ["2800Pa puissance", "7cm d'épaisseur", "Alexa/Google", "2h autonomie"],
    badge: "tendance",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=600&fit=crop",
    stock: "en stock", rating: 4.5, reviews: 267,
  },
  {
    id: "17", name: "Diffuseur huiles essentielles LED", slug: "diffuseur-huiles",
  ...
  {
    id: "18", name: "Purificateur d'air HEPA", slug: "purificateur-air-hepa",
  ...
  {
    id: "19", name: "Prise connectée WiFi", slug: "prise-connectee-wifi",
    category: "maison", price: 14.99, comparePrice: 22.99,
    description: "Prise intelligente WiFi avec compteur d'énergie. Contrôlez vos appareils depuis votre phone.",
  ...
  {
    id: "20", name: "Lampe de bureau LED tactile", slug: "lampe-bureau-led",
  ...
  // ─── DÉCO & CADEAUX ────────────────────────────────────────
  {
    id: "21", name: "Tasse personnalisée minimaliste", slug: "tasse-personnalisee",
  ...
  {
    id: "22", name: "Lampe LED lune 3D", slug: "lampe-lune-led",
  ...
  {
    id: "23", name: "Cadre photo LED personnalisé", slug: "cadre-photo-led",
  ...
  {
    id: "24", name: "Bougie parfumée soja luxe", slug: "bougie-parfumee-soja",
  ...
  {
    id: "25", name: "Porte-clés personnalisé gravé", slug: "porte-cles-grave",
    category: "deco", price: 12.99,
    description: "Porte-clés en acier inoxydable avec gravure personnalisée. Cadeau idéal toute occasion.",
    features: ["Inox 316L", "Gravure laser", "Personnalisable", "Livraison boîte"],
    badge: "nouveau",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=600&fit=crop",
    stock: "en stock", rating: 4.5, reviews: 143,
  },

  // ─── ÉCO-RESPONSABLE ───────────────────────────────────────
  {
    id: "26", name: "Gourde isotherme inox 500ml", slug: "gourde-isotherme-inox",
  ...
  {
    id: "27", name: "Kit brosses bambou x4", slug: "brosse-dents-bambou",
  ...
  {
    id: "28", name: "Sac à vrac réutilisable x5", slug: "sac-vrac-reutilisable",
  ...
  {
    id: "29", name: "Savon solide cheveux bio", slug: "savon-solide-cheveux",
    category: "eco", price: 9.99,
    description: "Shampoing solide 100% naturel, sans sulfate ni paraben. Équivalent 3 flacons liquide.",
    features: ["Sans sulfate", "Sans paraben", "= 3 flacons", "Tous types cheveux"],
    badge: "tendance",
    image: "https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=600&h=600&fit=crop",
    stock: "en stock", rating: 4.4, reviews: 187,
  },
  {
    id: "30", name: "Lunch box inox hermétique", slug: "lunch-box-inox",
  ...
  // ─── FITNESS ───────────────────────────────────────────────
  {
    id: "31", name: "Bandes de résistance x5", slug: "bandes-resistance",
  ...
  {
    id: "32", name: "Rouleau de massage fascia", slug: "rouleau-massage-fascia",
  ...
  {
    id: "33", name: "Tapis de yoga antidérapant", slug: "tapis-yoga-antiderapant",
  ...
  {
    id: "34", name: "Corde à sauter intelligente", slug: "corde-sauter-intelligente",
  ...
  {
    id: "35", name: "Shaker protéine 700ml", slug: "shaker-proteine",
  ...
  {
    id: "36", name: "Gants de musculation grip", slug: "gants-musculation",
    category: "fitness", price: 17.99, comparePrice: 25.99,
    description: "Gants de musculation avec support poignet intégré. Paume silicone antidérapante.",
    features: ["Support poignet", "Silicone antidérapant", "Tailles XS-XL", "Respirant"],
    badge: "tendance",
  ...
  {
    id: "38", name: "Masque LED thérapie lumière", slug: "masque-led-therapie",
  ...
  {
    id: "39", name: "Rouleau jade gua sha", slug: "rouleau-jade-gua-sha",
  ...
  {
    id: "40", name: "Sérum vitamine C 30ml", slug: "serum-vitamine-c",
  ...
  {
    id: "41", name: "Brosse nettoyante visage sonique", slug: "brosse-nettoyante-sonique",
  ...
  // ─── CUISINE ───────────────────────────────────────────────
  {
    id: "42", name: "Coupe-légumes mandoline pro", slug: "mandoline-legumes",
  ...
  {
    id: "43", name: "Machine à café capsules", slug: "machine-cafe-capsules",
  ...
  {
    id: "44", name: "Balance cuisine numérique", slug: "balance-cuisine",
  ...
  {
    id: "45", name: "Moule silicone formes variées", slug: "moule-silicone",
  ...
  {
    id: "46", name: "Blender portable USB", slug: "blender-portable-usb",
  ...
  // ─── VOYAGE ────────────────────────────────────────────────
  {
    id: "47", name: "Organisateur valise x6", slug: "organisateur-valise",
  ...
  {
    id: "48", name: "Adaptateur universel 150 pays", slug: "adaptateur-universel",
  ...
  {
    id: "49", name: "Oreiller gonflable voyage", slug: "oreiller-gonflable",
  ...
  {
    id: "50", name: "Cadenas TSA à code", slug: "cadenas-tsa",
    category: "voyage", price: 11.99,
    description: "Cadenas approuvé TSA pour valises. Code 3 chiffres, câble acier, aluminium léger.",
    features: ["Approuvé TSA", "Câble acier", "Code 3 chiffres", "Aluminium léger"],
    badge: "tendance",
    image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=600&fit=crop",
    stock: "en stock", rating: 4.4, reviews: 234,
  },
  {
    id: "51", name: "Trousse de toilette imperméable", slug: "trousse-toilette",
  ...
  // ─── BÉBÉ & ENFANTS ────────────────────────────────────────
  {
    id: "52", name: "Veilleuse étoiles projection", slug: "veilleuse-etoiles",
  ...
  {
    id: "53", name: "Thermomètre bébé sans contact", slug: "thermometre-bebe",
  ...
  {
    id: "54", name: "Tapis d'éveil musical bébé", slug: "tapis-eveil-bebe",
  ...
  {
    id: "55", name: "Coupe-ongles bébé sécurisé", slug: "coupe-ongles-bebe",
    category: "bebe", price: 12.99,
    description: "Lime électrique douce pour ongles bébé. 4 têtes, LED intégrée, silencieux.",
    features: ["4 têtes", "LED intégrée", "Ultra-silencieux", "USB rechargeable"],
    badge: "tendance",
    image: "https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600&h=600&fit=crop",
    stock: "en stock", rating: 4.5, reviews: 267,
  },
  {
    id: "56", name: "Babyphone vidéo WiFi", slug: "babyphone-video",
  ...
  {
    id: "57", name: "Jouet Montessori tri formes", slug: "montessori-tri-formes",
  ...
  {
    id: "58", name: "Chaise haute bébé pliable", slug: "chaise-haute-pliable",
    category: "bebe", price: 49.99, comparePrice: 74.99,
    description: "Chaise haute compacte pliable en 1 sec. Harnais 5 points, plateau amovible.",
    features: ["Pliage 1 sec", "Harnais 5 points", "Plateau amovible", "6-36 mois"],
    badge: "tendance",
    image: "https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600&h=600&fit=crop",
    stock: "en stock", rating: 4.5, reviews: 178,
  },
  {
    id: "59", name: "Coussin allaitement multiposition", slug: "coussin-allaitement",
    category: "bebe", price: 29.99, comparePrice: 42.99,
    description: "Coussin d'allaitement ergonomique multiposition. Housse déhoussable lavable en machine.",
    features: ["Ergonomique", "Multiposition", "Housse lavable", "Fibres creuses"],
    badge: "best-seller",
    image: "https://images.unsplash.com/photo-1519689680058-324335c77eba?w=600&h=600&fit=crop",
    stock: "en stock", rating: 4.7, reviews: 289,
  },
  {
    id: "60", name: "Sac à langer imperméable", slug: "sac-a-langer",
